...
def video_detection(path_x , user , mail):
    ...
    while True:
        ...
        if detection_occurred:
            ...
            if time_diff >= 20: #detect every ... seconds 
                ...
                send_mail(mail , file_path  , class_name , 'current_userlocation')
...
def video_detection2(video_path, user, mail):
    img_name= re_image_name() 
    ...
    while cap.isOpened():
        ...
        results = model(img, imgsz = 1218 , conf = 0.4)
